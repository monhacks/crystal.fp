...
; entries correspond to move ids (see constants/move_constants.asm)
	...
	move FIRE_PUNCH,   EFFECT_BURN_HIT,           75, FIRE,          PHYSICAL, 100, 15,  30
	move ICE_PUNCH,    EFFECT_FREEZE_HIT,         75, ICE,           PHYSICAL, 100, 15,  10
	move THUNDERPUNCH, EFFECT_PARALYZE_HIT,       75, ELECTRIC,      PHYSICAL, 100, 15,  30
	...
	move BIND,         EFFECT_TRAP_TARGET,        20, NORMAL,        PHYSICAL,  75, 20,   0
	...
	move FURY_ATTACK,  EFFECT_MULTI_HIT,          20, NORMAL,        PHYSICAL,  85, 20,   0
	...
	move WRAP,         EFFECT_TRAP_TARGET,        20, NORMAL,        PHYSICAL,  85, 20,   0
	...
	move TWINEEDLE,    EFFECT_POISON_MULTI_HIT,   25, BUG,           PHYSICAL, 100, 20,  30
	...
	move ACID,         EFFECT_DEFENSE_DOWN_HIT,   40, POISON,        SPECIAL,  100, 30,  30
	move EMBER,        EFFECT_BURN_HIT,           40, FIRE,          SPECIAL,  100, 20,  30
	move FLAMETHROWER, EFFECT_BURN_HIT,           95, FIRE,          SPECIAL,  100, 10,  30
	...
	move PSYBEAM,      EFFECT_CONFUSE_HIT,        65, PSYCHIC_TYPE,  SPECIAL,  100, 20,  30
	move BUBBLEBEAM,   EFFECT_SPEED_DOWN_HIT,     65, WATER,         SPECIAL,  100, 20,  30
	move AURORA_BEAM,  EFFECT_ATTACK_DOWN_HIT,    65, ICE,           SPECIAL,  100, 20,  30
	...
	move MEGA_DRAIN,   EFFECT_LEECH_HIT,          70, GRASS,         SPECIAL,   95, 15,   0
	...
	move THUNDERSHOCK, EFFECT_PARALYZE_HIT,       40, ELECTRIC,      SPECIAL,  100, 20,  30
	move THUNDERBOLT,  EFFECT_PARALYZE_HIT,       95, ELECTRIC,      SPECIAL,  100, 10,  30
	move THUNDER_WAVE, EFFECT_PARALYZE,            0, ELECTRIC,      STATUS,   100, 20,   0
	move THUNDER,      EFFECT_THUNDER,           120, ELECTRIC,      SPECIAL,   70,  5,  30
	...
	move CONFUSION,    EFFECT_CONFUSE_HIT,        50, PSYCHIC_TYPE,  SPECIAL,  100, 25,  30
	move PSYCHIC_M,    EFFECT_SP_DEF_DOWN_HIT,    90, PSYCHIC_TYPE,  SPECIAL,  100, 10,  30
	...
	move SMOG,         EFFECT_POISON_HIT,         40, POISON,        SPECIAL,   80, 20,  30
	move SLUDGE,       EFFECT_POISON_HIT,         65, POISON,        SPECIAL,  100, 20,  30
	move BONE_CLUB,    EFFECT_FLINCH_HIT,         65, GROUND,        PHYSICAL,  85, 20,  30
	move FIRE_BLAST,   EFFECT_BURN_HIT,          120, FIRE,          SPECIAL,   85,  5,  30
	...
	move CONSTRICT,    EFFECT_SPEED_DOWN_HIT,     30, NORMAL,        PHYSICAL, 100, 35,  30
	...
	move LEECH_LIFE,   EFFECT_LEECH_HIT,          40, BUG,           PHYSICAL, 100, 20,   0
	...
	move BUBBLE,       EFFECT_SPEED_DOWN_HIT,     20, WATER,         SPECIAL,  100, 30,  30
	move DIZZY_PUNCH,  EFFECT_CONFUSE_HIT,        70, NORMAL,        PHYSICAL, 100, 10,  30
	...
	move FURY_SWIPES,  EFFECT_MULTI_HIT,          20, NORMAL,        PHYSICAL,  80, 15,   0
	move BONEMERANG,   EFFECT_DOUBLE_HIT,         50, GROUND,        PHYSICAL,  90, 10,   0
	move REST,         EFFECT_HEAL,                0, PSYCHIC_TYPE,  STATUS,   100, 10,   0
	move ROCK_SLIDE,   EFFECT_FLINCH_HIT,         90, ROCK,          PHYSICAL,  90, 10,  30
	move HYPER_FANG,   EFFECT_FLINCH_HIT,         70, NORMAL,        PHYSICAL,  90, 15,  30
	...
	move FLAME_WHEEL,  EFFECT_FLAME_WHEEL,        60, FIRE,          PHYSICAL, 100, 25,  30
	...
	move OCTAZOOKA,    EFFECT_ACCURACY_DOWN_HIT,  65, WATER,         SPECIAL,   85, 15,  30
	...
	move GIGA_DRAIN,   EFFECT_LEECH_HIT,         100, GRASS,         SPECIAL,   90, 10,   0
	...
	move SACRED_FIRE,  EFFECT_SACRED_FIRE,       100, FIRE,          PHYSICAL, 100,  5, 100
	...
	move HIDDEN_POWER, EFFECT_HIDDEN_POWER,       60, NO_TYPE,    	 SPECIAL,  100, 15,   0
	move CROSS_CHOP,   EFFECT_NORMAL_HIT,        100, FIGHTING,      PHYSICAL,  80,  5,   0
	move TWISTER,      EFFECT_TWISTER,            40, DRAGON,        SPECIAL,  100, 20,  30
	...
	move SHADOW_BALL,  EFFECT_SP_DEF_DOWN_HIT,    80, GHOST,         SPECIAL,  100, 15,  30
	move FUTURE_SIGHT, EFFECT_FUTURE_SIGHT,       80, PSYCHIC_TYPE,  SPECIAL,   90, 15,   0
	move ROCK_SMASH,   EFFECT_DEFENSE_DOWN_HIT,   50, FIGHTING,      PHYSICAL, 100, 15,  30
	move WHIRLPOOL,    EFFECT_TRAP_TARGET,        20, WATER,         SPECIAL,   70, 15,   0
	move BEAT_UP,      EFFECT_BEAT_UP,            10, DARK,          PHYSICAL, 100, 10,   0
	move BULK_UP,	   EFFECT_BULK_UP,			   0, FIGHTING,		 STATUS,   100, 10,	  0
